...
**activity**  Art der Aktivität die die beiden Knoten verbindet  
1 = Drohung  
2 = Überfall  
3 = Mord
...
**id**  (eindeutige Codierung jedes Akteurs/Knotens)  
...
**position**  
Position innerhalb der Mafiastrukturen 1 = Aussenstehender  
2 = Handlanger  
3 = Oberhaupt
...
**location**  
Ort an dem die Person tätig/am häufigsten tätig war
